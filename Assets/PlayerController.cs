...
public class PlayerController : MonoBehaviour
{
    ...
    void Update()
    {
       ...
       // Vector3 targetPosition;
        //targetPosition = new Vector3(transform.position.x, transform.position.y + 4f, transform.position.z - 13);
        //cam.transform.position = Vector3.Lerp(cam.transform.position, targetPosition, smoothing * Time.deltaTime);
